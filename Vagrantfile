Vagrant.configure("2") do |config|
  config.vm.define :percona1 do |percona1_config|
        ...
        percona1_config.vm.network "forwarded_port", guest: 3066, host: 30661
  ...
  config.vm.define :percona2 do |percona2_config|
        ...
        percona2_config.vm.network "forwarded_port", guest: 3066, host: 30662
  ...
  config.vm.define :percona3 do |percona3_config|
        ...
        percona3_config.vm.network "forwarded_port", guest: 3066, host: 30663
